...
<div class="container">
    <!-- Default form login -->
    <form class="text-center border border-light p-5 mt-5" action="<?php print RUTA; ?>admonUsuarios/alta/" method="POST">
        ...
        value="<?php isset($datos["data"]["password1"]) ? print $datos["data"]["password1"] : "" ?>">
        <!-- Contraseña-->
        <input type="password" id="password2" name="password2" class="form-control mb-4" placeholder="Repita su contraseña" 
        value="<?php isset($datos["data"]["password2"]) ? print $datos["data"]["password2"] : "" ?>">
