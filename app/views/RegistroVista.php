...
<div class="container">
    ...
    <form class="text-center border border-light p-5 mt-5" method="POST">
        ...
        <!-- Dirección -->
        <input type="text" id="direccion" name="direccion" class="form-control mb-4" placeholder="Direccion" value="<?php isset($datos["data"]["nombre"]) ? print $datos["data"]["direccion"] : "" ?>">
        <!-- ciudad-->
        <input type="text" id="ciudad" name="ciudad" class="form-control mb-4" placeholder="ciudad" value="<?php isset($datos["data"]["nombre"]) ? print $datos["data"]["ciudad"] : "" ?>">
        <!--Código Postal -->
        <input type="text" id="codigoPostal" name="codigoPostal" class="form-control mb-4" placeholder="Código Postal" value="<?php isset($datos["data"]["nombre"]) ? print $datos["data"]["codigoPostal"] : "" ?>">
        <!-- Pais-->
        <input type="text" id="pais" name="pais" class="form-control mb-4" placeholder="Pais" value="<?php isset($datos["data"]["nombre"]) ? print $datos["data"]["pais"] : "" ?>">
        <!-- Contraseña-->
